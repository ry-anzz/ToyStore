...
export default function LoginPage() {
    ...
    const handleLogin = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        // Em um projeto real:
        // 1. Chamar a API do Spring Boot com email e senha.  
        // 2. Se a API retornar sucesso e um token, chamar login().
        
        // SIMULAÇÃO: Chamada direta à função de login
        login(email, "token_simulado_para_faculdade"); 
  ...
  return (
    <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 space-y-6 border-t-8 border-yellow-500 transform hover:scale-105 transition-transform duration-300">
      ...
      <form onSubmit={handleLogin} className="space-y-4"> {/* Adicionado onSubmit */}
        <div>
